...
ax.set_ylim(-5, 20)  # Set appropriate y-axis limits
#ax.set_ylim(-100, 100)  # Set appropriate y-axis limits
...
def animate(i):
    ...
    new_value = TorquimeterCommands.ReadRaw(SensorTorque)[2]
