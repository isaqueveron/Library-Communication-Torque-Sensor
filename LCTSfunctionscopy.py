...
__date    : 2025
__version : versao teste com heranca
...
class TorquimeterCommands(Torquimeter):
    # Initialize the parent Torquimeter class
    def __init__(self, Port: str, Tm_max: float, Rpm_max: float,
                 Baudrate=230400, Timeout=0.003, byte_resolution=25000):
        super().__init__(Port, Tm_max, Rpm_max, Baudrate, Timeout, byte_resolution)
